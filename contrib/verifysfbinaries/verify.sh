...
###   This script attempts to download the signature file SHA256SUMS.asc from alqo.org
...
SIGNATUREFILE="https://alqo.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://alqo.org/bin/"
VERSIONPREFIX="alqo-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'alqo-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[alqo-]<version>-[rc[0-9]] (example: alqo-0.9.2-rc1)"
   echo "wget output:"
