...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the alqo repository."
  exit 1
fi
...
# See https://github.com/alqo/alqo/issues/16064
...
echo
echo 'When compiling alqod, run `./configure` in the following way:'
echo
