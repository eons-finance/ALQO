...
"""Verify that starting alqo with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start alqo with -h for help text")
        ...
        self.log.info("Start alqo with -version for version information")
