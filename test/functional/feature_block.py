...
This reimplements tests from the alqoj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure alqod isn't accepting b26
        ...
        # Extend the b28 chain to make sure alqod isn't accepting b28
        ...
        #    Low-S and High-S values (whereas the alqo code has custom code which does so);
