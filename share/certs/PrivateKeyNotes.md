...
allowing somebody to distribute a Bitcoin-Qt.app or alqo-qt-setup.exe with a valid
...
that the alqo-qt.exe file inside the installer had not been tampered with.
