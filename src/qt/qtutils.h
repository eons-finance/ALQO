...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, ALQOGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, ALQOGUI *gui, double posX = 3);
