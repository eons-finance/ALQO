...
public:
    ...
    explicit ALQOGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ALQOGUI();
...
public slots:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a alqo wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
