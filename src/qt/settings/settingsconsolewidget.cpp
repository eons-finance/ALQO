...
#include "qt/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ALQOGUI* _window, QWidget *parent) :
