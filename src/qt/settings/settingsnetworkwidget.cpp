...
#include "qt/settings/settingsnetworkwidget.h"
#include "qt/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ALQOGUI* _window, QWidget *parent) :
