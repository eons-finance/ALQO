...
#include "qt/coincontrolpivwidget.h"
#include "qt/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select ALQO Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ALQO");
    ...
    ui->labelValueAfter->setText("0.00 ALQO");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ALQO");
    ui->labelValueFee->setText("0.00 ALQO");
