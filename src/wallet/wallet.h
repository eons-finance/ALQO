...
enum ZerocoinSpendStatus {
    ZALQO_SPEND_OKAY = 0,                            // No error
    ZALQO_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZALQO_WALLET_LOCKED = 2,                         // Wallet was locked
    ZALQO_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZALQO_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZALQO_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZALQO_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZALQO_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZALQO_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZALQO_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZALQO_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZALQO_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZALQO_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZALQO_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZALQO_SPENT_USED_ZPIV = 14,                      // Coin has already been spend
    ZALQO_TX_TOO_LARGE = 15,                          // The transaction is larger than the max tx size
    ZALQO_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
};
